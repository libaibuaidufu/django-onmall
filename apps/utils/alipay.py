...
from onmall.settings import private_key_path,ali_pub_key_path
...
class AliPay(object):
    ...
    def direct_pay(self, subject, out_trade_no, total_amount, return_url=None, **kwargs):  #自己商品参数
        biz_content = {
            "subject": subject,
